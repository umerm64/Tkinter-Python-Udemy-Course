...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.button1 = Button(self, bg="#98DBC6", bd=12, text="7", padx=33, pady=25, font=("Helvetica",20,'bold'), command=lambda : self.buttonClick(7))
        self.button1.grid(row=2, column=0, sticky=W)

        self.button2 = Button(self, bg="#98DBC6", bd=12, text="8", padx=35, pady=25, font=("Helvetica",20,'bold'), command=lambda : self.buttonClick(8))
        self.button2.grid(row=2, column=1, sticky=W)

        self.button3 = Button(self, bg="#98DBC6", bd=12, text="9", padx=33, pady=25, font=("Helvetica",20,'bold'), command=lambda : self.buttonClick(9))
        ...
        self.button5 = Button(self, bg="#98DBC6", bd=12, text="5", padx=35, pady=25, font=("Helvetica",20,'bold'), command=lambda : self.buttonClick(5))
        ...
        self.button8 = Button(self, bg="#98DBC6", bd=12, text="2", padx=35, pady=25, font=("Helvetica",20,'bold'), command=lambda : self.buttonClick(2))
        ...
        self.Addbutton = Button(self, bg="#98DBC6", bd=12, text="+", padx=36, pady=25, font=("Helvetica",20,'bold'), command=lambda : self.buttonClick("+"))
        ...
        self.Equalbutton = Button(self, bg="#E6D72A", bd=12, text="=", padx=100, pady=25, font=("Helvetica",20,'bold'), command=self.CalculateTask)
